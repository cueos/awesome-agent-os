...
- **[SandBase Harness](https://github.com/sandbaseai/sandbase-harness)** — Self-hosted runtime for persistent agent sessions, MCP tools, approvals, and backend-selectable sandboxes.
