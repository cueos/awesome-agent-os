...
- **[sandbase-harness](https://github.com/sandbaseai/sandbase-harness)** — Local-first runtime for durable agent sessions, sandboxed tools, MCP access, approvals, credentials, and replay.
